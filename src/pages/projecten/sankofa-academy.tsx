            ...
            <section data-main-section>
                ...
                <div className={styles.workshopContainer}>
                    ...
                    <div data-main-content className={styles.workshopInfo}>
                        <p>
                            <strong>Sankofa Academy</strong> is een educatief programma in het kader van een gedeelde
                            geschiedenis om mensen van Afrikaanse afkomst te leren over hun eigen geschiedenis en de
                            maatschappelijke gevolgen hiervan. Middels het organiseren van ontmoetingsactiviteiten is
                            Eternity Percussion bezig met het bijdragen aan het empoweren en emanciperen van
                            Afrikaanse-Nederlandse groepen door middels van verschillende educatieve activiteiten.
                        </p>
                        ...
                        <p>
                            De onderwerpen gedurende dit programma gaat over de Trans-Atlantische slavernij,
                            kolonialisme en de historische periodes die van belang zijn geweest voor de opbouw van de
                            huidige samenleving. Door dit soort onderwerpen aan te kaarten en met elkaar in gesprek te
                            gaan versterkt dit de identiteit van de deelnemers, bewustwording en hun positie binnen de
                            Nederlandse samenleving.
                        </p>

                        <p>
                            Ook leren de verschillende publieksgroepen elkaar hierdoor te respecteren er wordt
                            wederzijds begrip naar elkaar geuit wat kan leiden tot sociale cohesie en verbroedering
                            onder elkaar. Dit project is in het kader van de afschaffing van de Trans-Atlantische
                            slavernij door Nederland in Suriname en de voormalige Nederlandse Antillen. Dit project is
                            in samenwerking met{" "}
