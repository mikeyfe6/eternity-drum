    ...
    return (
        <div className={styles.bookingsContainer} data-main-form>
                    ...
                    <div className="form-submit">
                        <div>
                            ...
                            <button
                                type="submit"
                                disabled={
                                    Object.values(fieldErrors).flat().length >
                                        0 || !isFormValid()
                                }
                            >
                                Verstuur
            ...
            <div data-main-content className={styles.bookingsInfo}>
                <p>
                    <strong>
                        Drumband Eternity Percussion treedt op in zowel binnen-
                        als buitenland. De afgelopen jaren heeft Eternity op
                        verschillende grote evenementen en festivals in
                        Nederland optredens verricht. Ook internationale
                        optredens zoals op Curaçao, in Suriname, Engeland
                        (Londen en Birmingham), Atlanta (USA) en Brazilië.
                    </strong>
                </p>
                <p>
                    In juli 2006 heeft Eternity de prijs gewonnen van Beste
                    Brassband Ortel Zomercarnaval 2006. Een vakkundige jury
                    heeft Eternity beoordeelt op de hoge kwaliteit van ritme,
                    muziek, juiste harmonie en gevarieerde show.
                </p>
                <p>
                    Wij zijn in te huren voor; <u>bedrijfsevenementen</u>,{" "}
                    <u>begrafenissen</u>, <u>bruiloften</u>, <u>jubilea</u>,{" "}
                    <u>openingen</u>, <u>parades</u>,{" "}
                    <u>theatervoorstellingen</u> en <u>verjaardagen</u>. Het
                    repertoire wordt afgestemd op het publiek en de gelegenheid.
                </p>
                <p>
                    Wij leveren formaties van{" "}
                    <b>
                        minimaal 6 en maximaal 15 drummers inclusief de
                        blazerssectie
                    </b>{" "}
                    voor setjes van 10 tot maximaal 30 min (Je kunt ook meerdere
                    setjes boeken).
                </p>
                <p>
                    ...
                    <a
                        href="#"
                        onClick={(event) => handleClick(inputRef, event)}
                    >
