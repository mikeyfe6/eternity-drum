	...
	return (
		<div className={styles.registerWrapper} data-main-form>
					...
					<div className="form-column collapse-one">
						...
						<div className="form-group house-number">
							...
							<input
								...
								className={
									fieldErrors.houseNumber && fieldErrors.houseNumber.length > 0
										? "error"
					...
					<div className="form-column">
						<div className="form-group first-name-parent">
							<label
								...
								className={
									focusedInput === "firstNameParent" || formData.firstNameParent
										? "visited"
										: ""
								}
							>
					...
					<div className="form-column collapse-six">
						<div className="form-group email-parent">
							...
							<input
								...
								className={
									fieldErrors.emailParent && fieldErrors.emailParent.length > 0
										? "error"
						...
						<div className="form-group phone-parent">
							...
							<input
								...
								className={
									fieldErrors.phoneParent && fieldErrors.phoneParent.length > 0
										? "error"
			...
			<div className={styles.registerConditions}>
				...
				<ul>
					<li>
						Eternity Percussion kan niet aansprakelijk worden gesteld voor enig
						lichamelijk letsel, schade of vermissing van eigendom tijdens de
						lessen en/of repetities
					</li>
